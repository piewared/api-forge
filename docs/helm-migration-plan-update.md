...
| **Rollback**                                         | Manual `kubectl` actions                                              | CLI: `uv run api-forge-cli deploy rollback [REV]` or `helm rollback`       | Huge operational improvement with interactive CLI                     |
| **Version Tracking**                                 | Git-only                                                              | CLI: `uv run api-forge-cli deploy history` or `helm history`               | Adds traceable deployment history with color-coded status             |
